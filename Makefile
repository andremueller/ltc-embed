...
ARGS = $(if $(FPS),--fps $(FPS)) --suffix $(SUFFIX) --duration $(DURATION) $(if $(OVERWRITE),--overwrite) --verbose
...
run: venv ## Process video files (INPUT_DIR, FPS, SUFFIX, DURATION, OVERWRITE)
